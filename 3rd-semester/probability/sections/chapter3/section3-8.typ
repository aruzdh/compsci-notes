...
#exercise()[
  ...
  - ¿Cuál es la probabilidad de que el siguiente cliente pida gasolina plus y llene el tanque?
  - ¿Cuál es la probabilidad de que el siguiente cliente llene el tanque?
  - Si el siguiente cliente llena el tanque, ¿cuál es la probabilidad de que pida gasolina regular, gasolina plus o gasolina premium?
]
...
#exercise()[
  ...
  - ¿Cuál es la probabilidad de que ningún carro esté disponible cuando se le necesite?
  - ¿Cuál es la probabilidad de que sólo un carro de bomberos esté disponible cuando se le necesite?
]
