...
$
P(A^c) = P(A^c inter B_1) + P(A^c inter B_2) = P(A^c bar.v B_1) space.med P(B_1) + P(A^c bar.v B_2) space.med P(B_2)
$
...
#example()[
  ...
  P(B bar.v A) &= (P(B inter A))/(P(A)) = (P(A bar.v B) space.med P(B))/(P(A))\
               ...
               &= ((0.95) (0.005))/((0.95) (0.0005) + (0.1) (1-0.005)) = 19/417
  $
]
...
#example()[
  ...
  P(B bar.v D) &= (P(B inter D))/(P(D)) = (P(D bar.v B) space.med P(B))/(P(D))\
               &= (P(D bar.v B) space.med P(B))/(P(D bar.v A) space.med P(A) + P(D bar.v B) space.med P(B) + P(D bar.v C) space.med P(C))\
...
#example()[
  ...
  P(A) &= P(A bar.v B) space.med P(B) + P(A bar.v C) space.med P(C)\
       &= 2/6 dot.c 4/6 + 5/8 dot.c 2/6 + 2/6 (4/6 + 5/8) = 62/48 dot.c 1/3 = 63/144 = 31/72
  $ 
]
