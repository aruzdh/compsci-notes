...
#align(center)[
  #canvas({
    ...
    grid((1,1),(8,4), step: .80)
    rect((1,1),(8,4), fill: red.transparentize(90%))
    content((8.7,4), text(size: 15pt)[$#text(red)[R]$])
    line((1,-0.5),(1,0.5))
  })
]
...
- Homogeneidad
$ integral_R c f(x,y) space.med dif A = c integral_R c f(x,y) space.med dif A $
- Monotonía
