...
\nt{
  Los subconjuntos de $\Omega$ se llaman \textbf{eventos.}
}
...
\ex{Proposiciones}{
  ...
  Entonces 
  \begin{align*}
    P(A) &= \frac{\mid A \mid}{\mid \Omega \mid} = \frac{\binom{5}{3}}{\binom{12}{3}}\\
         ...
         &= \frac{ \frac{20}{2} }{ \frac{1320}{6} } = \frac{10}{220} = \frac{1}{22}  \\
  \end{align*}
}
...
\qs{Proposiciones} {
  ...
  \sol{
    ...
    Entonces 
    \begin{align*}
      P(A) &= \frac{\mid A \mid ~ \mid B \mid}{\mid \Omega \mid} = \frac{ \binom61 \binom52} {\binom{11}3} \\ 
