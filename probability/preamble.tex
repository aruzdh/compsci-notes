...
\setmainfont{Iosevka} % Sets the main text font

% Use warnings-off to suppress specific unicode-math warnings about mathtools conflicts
\usepackage[
  mathrm=sym,
  warnings-off={mathtools-colon,mathtools-overbracket} % <--- THIS IS THE KEY!
]{unicode-math}
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{claim}{Afirmación}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\makeatletter
\newtcbtheorem[use counter=questioncounter]{question}{Pregunta}{enhanced,
	breakable,
	colback=white,
...
\newtcbtheorem[number within=chapter]{wconc}{Concepto Erróneo}{
	breakable,
	enhanced,
	colback=white,
	colframe=myr,
