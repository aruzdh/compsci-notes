...
\nt{
  Ciertamente, en el ejemplo anterior hay un abuso de notación, pero se mira lindo.
  Una versión más correcta se da a continuación.
}

Dado el autómata del ejemplo anterior. La tabla de transiciones del autómata es la siguiente.
\begin{table}[h]
\centering
  \begin{tabular}{c | c | c}
  & 0 & 1 \\
